...
```
##  int [1:100] 2 3 5 7 12 17 18 26 30 42 ...
```
...
```
##  int [1:50] 1 6 8 10 16 20 21 23 24 28 ...
```
...
```
##  int [1:256] 2 8 10 12 13 14 15 16 20 28 ...
```
...
```
##  int [1:512] 4 5 6 17 19 21 26 27 29 31 ...
```
...
## 
##  1) root 512 166 neg (0.3242 0.6758)  
##    2) glucose>=127.5 184  78 pos (0.5761 0.4239)  
##      4) mass>=29.85 141  44 pos (0.6879 0.3121) *
##      5) mass< 29.85 43   9 neg (0.2093 0.7907)  
##       10) glucose>=164 7   2 pos (0.7143 0.2857) *
##       11) glucose< 164 36   4 neg (0.1111 0.8889) *
##    3) glucose< 127.5 328  60 neg (0.1829 0.8171) *
```
...
##          2   neg      neg   0.1829   0.8171
##          8   neg      neg   0.1829   0.8171
##         10   pos      neg   0.1829   0.8171
## ---                                        
##        760   pos      pos   0.7070   0.2930
##        762   pos      pos   0.7070   0.2930
##        768   neg      neg   0.1649   0.8351
```
...
##         10   pos      neg   0.1829   0.8171
## ---                                        
##        761   neg      neg   0.1829   0.8171
##        764   neg      neg   0.1829   0.8171
##        767   pos      neg   0.1829   0.8171
```
