...
The goal of the cluster analysis is to find patterns within the data by grouping them into clusters where each 
cluster contains similar observations. 

The work is still in progress, but most of the functionality 
is already implemented in the package. See [mlr3cluster](https://github.com/mlr-org/mlr3cluster) for the 
current state. 
