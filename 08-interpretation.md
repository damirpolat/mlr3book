...
##   -> predicted values  :  numerical, min =  446422 , mean =  7474347 , max =  89719200  
##   -> model_info        :  package mlr3 , ver. 0.3.0 , task regression (  default  ) 
##   -> residual function :  difference between y and yhat (  default  )
##   -> residuals         :  numerical, min =  -7929313 , mean =  -1060 , max =  17449300  
...
## 1        _full_model_           1306937 Ranger RF
## 2           value_eur           1306937 Ranger RF
## 3           weight_kg           1364015 Ranger RF
## 4           height_cm           1372389 Ranger RF
## 5 goalkeeping_kicking           1373956 Ranger RF
## 6    movement_balance           1377532 Ranger RF
```
...
## 1 skill_ball_control Ranger RF   5 5854162     0
## 2    skill_dribbling Ranger RF   7 6076986     0
## 3    skill_dribbling Ranger RF  11 6076149     0
## 4    skill_dribbling Ranger RF  12 6075295     0
## 5    skill_dribbling Ranger RF  13 6075331     0
## 6    skill_dribbling Ranger RF  14 6073289     0
```
...
```
##                                         contribution
## Ranger RF: intercept                         7474347
## Ranger RF: movement_reactions = 96          11759242
## Ranger RF: skill_ball_control = 92           7725994
## Ranger RF: mentality_positioning = 95        5084623
## Ranger RF: attacking_finishing = 94          3172390
## Ranger RF: attacking_short_passing = 83      4107979
```
